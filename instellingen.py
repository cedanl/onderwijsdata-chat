...
# Gangbare afkortingen/aliassen per instelling.
# De feitelijke instellingenlijst wordt dynamisch uit DUO-data geladen;
# dit zijn alleen de aliassen die niet in de brondata voorkomen.
